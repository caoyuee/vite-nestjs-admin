  ...
  <el-dialog v-model="dialogVisible" title="修改密码" width="500px" draggable>
   <el-form ref="ruleFormRef" label-width="110px" label-suffix=" :" :rules="rules"
      ...
      <el-form-item label="旧密码" prop="oldPassword">
        <el-input v-model="passwordForm.oldPassword" type="password" show-password placeholder="请输入旧密码" clearable></el-input>
      </el-form-item>
      <el-form-item label="账号" prop="newPassword">
        <el-input v-model="passwordForm.newPassword" type="password" show-password placeholder="请输入新密码" clearable></el-input>
      </el-form-item>
      <el-form-item label="密码" prop="newPasswordAgain">
        <el-input v-model="passwordForm.newPasswordAgain" type="password" show-password placeholder="请再次输入密码" clearable></el-input>
      </el-form-item>
    </el-form>
    <template #footer>
...
const rules = reactive({
  oldPassword: [{ required: true, message: "请输入旧密码"},{ message: "密码必须由6-16位数字和字母组成",validator: /^[A-Za-z0-9]{6,16}$/}],
  newPassword: [{ validator: validatePass,trigger: 'blur' }],
  newPasswordAgain: [{ validator: validatePass1,trigger: 'blur' }],
